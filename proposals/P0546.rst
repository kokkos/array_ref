...
.. code-block:: c++
  ...
  template< class ArrayType , class ... AccessProperties >
    std::conditional_t< extent_v<ArrayType>==0
                      , span<char[]>
                      , span<char[sizeof(ArrayType)]>
...
----------------------------------------------------------------------------
  ...
  **3** Requires: ``remove_all_extent_t<ArrayType>`` is a complete
...
.. code-block:: c++
  ...
  class span {
  public:
    using element_type = remove_all_extent_t<ArrayType> ;
...
..
  ...
  ``remove_all_extent_t<lhsArrayType>`` and
  ``remove_all_extent_t<rhsArrayType>`` are different types
