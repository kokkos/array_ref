...
otherwise any or all of the array bound constant expressions may be omitted.*
  ...
  Note that it is a simple one-line change in Clang to disable the error message and
  allow omission of second and subsequent dimensions.

  Note that gcc 4.7, 4.8, and 4.9 implicitly support such type declarations as
...
A view constructor with arguments for each implicit dimension is required.
