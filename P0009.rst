...
Unlike N4512, this proposal
  ...
  - achieves zero-overhead abstraction for *constexpr* extents and strides whichprovides more opportunities for the compiler to optimize member access functions.
