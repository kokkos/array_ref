...
2. *atomic protected* such that member access operations are overloaded
via proxy objects to atomic operations,
...
**template< typename IntegralType > constexpr size_t extent( const IntegralType & r ) const**
  ...
  [Note: A default constructed view will have extent(r) == 0
