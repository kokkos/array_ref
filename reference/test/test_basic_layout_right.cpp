...
{ // {{{
    ...
    basic_layout_right<dimensions<1>, dimensions<0> > const l;
...
{ // {{{
    ...
    basic_layout_right<dimensions<1, 1>, dimensions<0, 0> > const l;
...
{ // {{{
    ...
    basic_layout_right<dimensions<1, 1, 1>, dimensions<0, 0, 0> >  const l;
    ...
    for (auto i = 0; i < d[0]; ++i)
    {
        auto const true_idx = (d[1]) * (d[2]) * (i) + (d[2]) * (j) + (k);
...
int main()
{
    {
        dimensions<> d;
        basic_layout_right<dimensions<>, dimensions<> >  const l;
