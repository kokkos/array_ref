...
{ // {{{
    ...
    basic_layout_right<decltype(s), decltype(p)> const l;
    ...
    basic_layout_right<decltype(sub_s), decltype(p)> const sub_l;
    ...
    {
        auto const true_idx = (d[1] + p[1]) * (i) + (j);
    ...
    {
        auto const true_idx
            = (sub_d[1] * sub_s[1] + p[1]) * (sub_s[0] * i) + (sub_s[1] * j);
...
{ // {{{
    ...
    basic_layout_right<decltype(s), decltype(p)> const l(s, p);
    ...
    basic_layout_right<decltype(sub_s), decltype(p)> const sub_l(sub_s, p);
